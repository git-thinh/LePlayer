$(function () {
    ...
    $('#ui-app').w2layout({
        ...
        padding: 0,
        panels: [
            { type: 'top', size: 78, resizable: false, content: '<div id="ui-top">' + top + '</div>', overflow: 'hidden', style: 'border:none;padding:0;' },
            ...
            { type: 'main', content: '<div id="ui-list">' + table + '</div>', style: 'border:none;padding:0;' },
            ...
            { type: 'bottom', size: 24, resizable: false, hidden: true, content: '<div id="ui-status">' + status + '</div>', overflow: 'hidden', style: 'border:none;padding:0;' }
        ]
    });
});
